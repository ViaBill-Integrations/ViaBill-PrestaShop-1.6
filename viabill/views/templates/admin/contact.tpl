...
<div class="container" style="margin-top: 20px;margin-bottom: 20px;">
    ...
    <form id="tech_support_form" action="{$action_url|escape:'htmlall':'UTF-8'}" method="post">
    <fieldset>
    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" required="true"
                 value="{$storeName|escape:'htmlall':'UTF-8'}" name="shop_info[name]" />
        </div>                
        <div class="form-group">
            <label>{l s='Store URL' mod='viabill'}</label>
            <input class="form-control" type="text" required="true"
             value="{$storeURL|escape:'htmlall':'UTF-8'}" name="shop_info[url]" />
        </div>
        <div class="form-group">
            <label>{l s='Store Email' mod='viabill'}</label>
            <input class="form-control" type="text" required="true"
             value="{$storeEmail|escape:'htmlall':'UTF-8'}" name="shop_info[email]" />
        </div>
        <div class="form-group">
            <label>{l s='Eshop Country' mod='viabill'}</label>
            <input class="form-control" type="text" required="true"
             value="{$storeCountry|escape:'htmlall':'UTF-8'}" name="shop_info[country]" />
        </div>
        <div class="form-group">
            <label>{l s='Eshop Language' mod='viabill'}</label>
            <input class="form-control" type="text" required="true"
             value="{$langCode|escape:'htmlall':'UTF-8'}" name="shop_info[language]" />
        </div>
        <div class="form-group">
            <label>{l s='Eshop Currency' mod='viabill'}</label>
            <input class="form-control" type="text" required="true"
             value="{$currencyCode|escape:'htmlall':'UTF-8'}" name="shop_info[currency]" />
        </div>                
        <div class="form-group">
            <label>{l s='Module Version' mod='viabill'}</label>
            <input class="form-control" type="text"
             value="{$module_version|escape:'htmlall':'UTF-8'}" name="shop_info[addon_version]" />
        </div>
        <div class="form-group">
            <label>{l s='PrestaShop Version' mod='viabill'}</label>
            <input type="hidden" value="prestashop" name="shop_info[platform]" />
            <input class="form-control" type="text"
             value="{$prestashop_version|escape:'htmlall':'UTF-8'}" name="shop_info[platform_version]" />
        </div>
        <div class="form-group">
            <label>{l s='PHP Version' mod='viabill'}</label>
            <input class="form-control" type="text"
             value="{$php_version|escape:'htmlall':'UTF-8'}" name="shop_info[php_version]" />
        </div>
        <div class="form-group">
            <label>{l s='Memory Limit' mod='viabill'}</label>
            <input class="form-control" type="text"
             value="{$memory_limit|escape:'htmlall':'UTF-8'}" name="shop_info[memory_limit]" />
        </div>
        <div class="form-group">
            <label>{l s='O/S' mod='viabill'}</label>
            <input class="form-control" type="text"
             value="{$os|escape:'htmlall':'UTF-8'}" name="shop_info[os]" />
        </div>
        <div class="form-group">
            <label>{l s='Debug File' mod='viabill'}</label>
            <input class="form-control" type="text"
             value="{$debug_file|escape:'htmlall':'UTF-8'}" name="shop_info[debug_file]" />
        </div>
        <div class="form-group">
        ...
        <input type="checkbox" value="accepted" required="true"
         class="form-check-input" name="terms_of_use" id="terms_of_use"/>
          <label class="form-check-label">I have read and accept the
           <a href="{$terms_of_use_url|escape:'htmlall':'UTF-8'}">Terms and Conditions</a></label>
    </div>       
