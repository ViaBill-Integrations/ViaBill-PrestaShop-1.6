...
class PaymentManagementTemplate implements TemplateInterface
{
    ...
    public function getHtml()
    {
        ...
        if ($this->module->isPS16()) {
            $paymentTemplate = 'views/templates/admin/payment-management.tpl';
        } else {
            $paymentTemplate = 'views/templates/admin/payment-management15.tpl';
        }

        return $this->smarty->fetch(
            $this->module->getLocalPath().$paymentTemplate
        );
    }
